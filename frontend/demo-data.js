...
,
  deployment:{environment_type:'Pilot',release_version:'1.3.0',auth_mode:'OIDC',database:'PostgreSQL 16',storage:'S3/MinIO',tls:false,total:24,pass:15,fail:1,pending:6,blocked:2,outcome:'Fail',ready:false,backup_status:'Pending',oidc_status:'Partial',rpo_rto:'Not measured',checks:[{code:'DATABASE_REACHABLE',status:'Pass',evidence:'db-probe'},{code:'BASELINE_COUNTS_VALID',status:'Pass',evidence:'41/266/63/75/12'},{code:'DEV_TOKENS_DISABLED',status:'Fail',evidence:'dev mode active'},{code:'BACKUP_RESTORE_TESTED',status:'Pending',evidence:''},{code:'OIDC_TOKEN_VALIDATION',status:'Pending',evidence:''},{code:'UAT_CRITICAL_PASS',status:'Blocked',evidence:'UAT incomplete'}]},
