...
CREATE TABLE intelligence_review_items (
	...
	CONSTRAINT uq_intelligence_review_items_session_recommendation UNIQUE (session_id, recommendation_id), 
	CONSTRAINT uq_intelligence_review_items_session_sequence UNIQUE (session_id, sequence), 
